-- Corrige a data padrão de registrar_compra para considerar
-- a data local de São Paulo, em vez do CURRENT_DATE em UTC.
--
-- Problema identificado:
-- após 21h no fuso de São Paulo, o banco em UTC já estava
-- no dia seguinte e compras sem p_data explícita eram gravadas
-- com a data incorreta.
--
-- Mantém datas explicitamente informadas sem alteração.
